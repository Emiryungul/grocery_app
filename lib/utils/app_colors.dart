...
class AppColors {
  ...
  static const Color darkPurpleColor = Color(0xFF59344F);
  ...
  static const Color blueTiffany = Color(0xff6AD5CB);
  static const Color blueLightCambridge = Color(0xff7FBEAB);
  static const Color blueDarkCambridge = Color(0xff7E998A);
  static const Color greyShipColor = Color(0xff85877C);
