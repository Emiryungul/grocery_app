...
class AddressController extends GetxController {
  ...
  final addressesController = Get.find<AddressesController>(); // Use Get.find to find AuthorizationController
  ...
  void onMapTapped(LatLng position) async {
    ...
    addressesController.latitudeController.text = position.latitude.toString();
    addressesController.longitudeController.text = position.longitude.toString();
    ...
    addressesController.addressInfoController.text = address;
